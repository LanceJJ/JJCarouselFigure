...
@interface JLXCarouselFigure()<UIScrollViewDelegate>

@property (nonatomic, copy) TapBlock tapBlock;
@property (nonatomic, copy) LoadImageBlock loadImageBlock;
@property (nonatomic, assign) JLXPageType pageType;
...
@implementation JLXCarouselFigure
